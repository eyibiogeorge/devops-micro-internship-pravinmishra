...
![Cloud Access](./screenshots/aws_free_tier.png)
...
| | |
|---|---|
| OS | Ubuntu Server 26.04 LTS (HVM) |
| Server IP | 54.147.146.88 |
| App URL | http://54.147.146.88 |

**Commands I ran:**

```bash
ls -l
chmod 400 "webservers-kp.pem"
ssh -i "webservers-kp.pem" ubuntu@ec2-54-147-146-88.compute-1.amazonaws.com
sudo apt update
